...
#Machine 1
def get_heat955t_1(speed):
    temp = 315 + (speed * 70)
    return temp


def get_speed955t_1(heat):
    speed = float((heat - 315) / 70)
    return speed

def get_heat955_1(speed):
    temp = 315 + (speed * 70)
    return temp


def get_speed955_1(heat):
    speed = float((heat - 315) / 70)
    return speed
...
def get_heat955t_2(speed):
    temp = 1 + (speed * 1)
    return temp


def get_speed955t_2(heat):
    speed = float((heat - 1) / 1)
    return speed

def get_heat955_2(speed):
    temp = 1 + (speed * 1)
    return temp


def get_speed955_2(heat):
    speed = float((heat - 1) / 1)
    return speed
...
def get_heat955t_4(speed):
    temp = 1 + (speed * 1)
    return temp


def get_speed955t_4(heat):
    speed = float((heat - 1) / 1)
    return speed

def get_heat955_4(speed):
    temp = 1 + (speed * 1)
    return temp


def get_speed955_4(heat):
    speed = float((heat - 1) / 1)
    return speed
...
def get_heat1055_4(speed):
    temp = 1 + (speed * 1)
    return temp
"""formula for seaming 1055 on machine 4"""
...
def get_heat1055t_4(speed):
    temp = 1 + (speed * 1)
    return temp
"""formula for taping one machine 4"""
